...
Most of the days receive around 7 to 15 calls. Some days receive more and some receive less; Those are found in the unusual_days data set. In the next step, where we look at the spikes, most days are in the middle of the chart at around 10.
...
The unusual days have either at least 18 calls or 3 or less calls. There is not really a true pattern, in my opinion; The days are scattered throughout the year.
...
It appears that the days that are considered the weekend have higher rates of calls compared to the middle of the week.
...
A good angle could be talking about the large spike in calls that there was between July and October. We could also talk about how there appears to be some form of spike every so often. Talking to dispatchers could be a good way to take a next step. They could potentially provide more details for us. 
