...
It appears that there is a slight positive correlation between FARMS percentage and % met or exceeded math expectations. It is unknown if this is significantly significant, but the line of best fit has a positive slope.
...
At 95% confidence, there is not a significant correlation between FARMS percentage and % met or exceeding math expectations. The line of best fit is mere coincidence.
...
WHITEMARSH ES has a residual of -34.8972916, the largest difference.
Gulph ES is next, coming in at -31.3432381.
CROOKED BILLET ES is 3rd, with a residual of 31.1111824
...
**WRITE YOUR ANSWER HERE**
The results of the model don’t support the school board member’s claim. The correlation between FARMS percentage and math scores is weak and not statistically significant. A story pitch would focus on questioning the accuracy of the board member’s statement and highlighting how the data shows far more variation than their claim suggests.
