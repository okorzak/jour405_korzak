...
I would say that this model is useful. It explains what generally produces  wins and shows that at least one factor, points scored, has a significant impact. Despite some variables being insignificant, it still offers a strong foundation for understanding which stats matter most, in this case points-scored.
...
The factor that has the most impact on wins is points-scored, not by surprise. If you score a lot of points, you'll win more games. Yards gained, on the other hand has very little impact. The team with the most yards by a good chunk, the Cowboys, had only 8 wins.
...
You could use the model to find out which stats actually determine winning and focus on those areas. It helps you explain why a team is doing good vs doing bad, based on the factors that have the biggest impact on team success.