...
I don't think that the headline would be appropriate for the first sample; the margin of error is 10%, meaning the actual support percentage could be in the low 40% area. For the other two samples; it probably wouldn't be a good idea, as the support percentage may be 50%, which isn't the majority.

A better headline may be "Around 50% Suppor New City Policy" or "Support for New City Policy is Split."
...
The conclusion from the data is that there is statistical evidence supporting the claim that the transit line has increased home values. Other factors, however, are inflation, which raises the price of everything, along with home renovations that have become more popular. Those can both also increase home values, but it is clear that the transit has increased home values. Market demand is also a factor. The transit, which would allow for more easy transportation, raises these homes demand. So, while there are lots of factors that have an impact on home value, it is clear that the addition of the transit lines have had a positive impact on home value, raising the home value by 6.8%. The current average home value is $285k, and will go up to $304.5k after the transit is complete.
