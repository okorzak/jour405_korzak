...
One concern with the survey could be the combining of certain ethnic groups. Combining small racial and ethnic groups into a single “Races/Ethnicity with Small Sample Sizes” category can undermine important and unique experiences of discrimination or belonging among those communities. This limits the accuracy of the survey’s conclusions about race and ethnicity.
#-------------------------------------------------------------------------------
#Survey Weighting
#-------------------------------------------------------------------------------
...
- Some groups of people are more likely to answer surveys than others (You should underweight these groups)
...
The range of weights in the data set is from 0.2298 to 3.0386, with the difference being 2.8088.

2. What does it mean when a respondent has a weight of 0.23? What about 3.04? **Write your answer here:**
If a respondent has a weight of .23, then that means the respondent is overrepresented in the the survey. If their weight is 3.04, then they are underrepresented in the survey.

3. Why might some respondents be weighted more heavily than others? **Write your answer here:**
Some groups may have a very low proportion of members responding. For example, if 10% of one demographic responds, but 80% of another responds, then the lower demographic would have higher weight/response compared to the other demographic.
...
The rarely/never voter category has the biggest different difference between weighted and unweighted results. The percentages for the always and sporadic are barely weighted, as their percentages are close to zero. Rarely/never, on the other hand, have very low and high percentages.

2. How might these differences affect reporting on likely voter turnout? **Write your answer here:**
These numbers could help make the statistics more accurate. Without the weights, it may appear that people who don't vote would vote at a much higher level, but the weights make the numbers more accurate. This helps journalists report more accurately.
...
The differences exist because some groups are less likely to respond to surveys. This can lead to groups being underrepresented, while some are overrepresented. Weighting helps make the polling a little more accurate.
