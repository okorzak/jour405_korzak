...
**ANSWER HERE**
The cities that stuck out the most were Baltimore City, Glen Burnie and Bensville
...
**ANSWER HERE**
The city with the highest race probability is Summerfield.The city is has a very high proportion of black residents; over 93%. The population isn't too high and  pridominantly black.
...
**ANSWER HERE**
The cities with the lowest hisp_prob have close numbers in tersm fo hispanic and non hispanic population.
...
**ANSWER HERE**
The cities at the top of the list are all relatively close to one another and they are all near DC. The cities are Langley Park, Wheaton and Adelphi. On the other hand, Lake Shore is the least diverse. It is south of Baltimore and near the eastern shore.
...
Headline - DC Suburbs Dominate Diversity

Lede - The top three highest diversity scores in the state of Maryland are all located close to our nation's capital. Diversity scores use census data to calculate the chance that two random people are different by race or ethnicity.

I would talk to government officials of the towns with high diversity scores and how being in a diverse area is beneficial.
