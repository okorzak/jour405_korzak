...
Every category had a high percent change, especially student sustainability and the counseling center. However, despite high percentage changes, the actual percentage of the total amount of fees is very minuscule. The bigger story is about athletics, which was the only category that didn't have a percent increase, as it stayed at the same number, 399, each year. The story out of this could be connected to NIL, which was legalized by the NCAA around 2021. In class, a student mentioned how there is an outside UMD NIL fund that gives donors tax breaks. This is likely a story that could come out of this data set.
