...
Some education levels are less likely to participate in polls. The polls appears to have more college education level participants, which means that they were probably more likely to respond to a survey than those with lower levels of education.
...
Survey Shows College-Educated are More Likely to Vote
...
The "high school or less" group changed the most. Their yes and no percentages each shifted by around 3%, while their unsure percentage moved by 2%. The college and some college groups showed very little change.
...
**Write your ANSWER HERE**
The weighted results account for over or underrepresented groups and help give a more accurate breakdown of the entire population.
...
Weighting can greatly impact a story; if certain polling is not weighted then the numbers may not accurately represent the data. 

2. How might the differences between weighted and unweighted results affect how you would report on this data?

**Write your ANSWER HERE**

I would probably try to explain how the original data may depict certain trends while the weighted data shows numbers that are more accurate.
...
I would want to know the demographics beyond the weighted data.
