...
**WRITE ANSWERS HERE:**
It appears that the amount of car deaths has significantly decreased since 7/2023. There was a slight rise but it has definitely fell off since the end of 2024.
...
- What does the 95% confidence interval show here? **WRITE ANSWER HERE:** It shows us where the true average number of monthly car thefts is likely to fall 95% of the time, based on our sample data.

- What figure(s) accurately reflects the number of car thefts in a typical month? **WRITE ANSWER HERE:** The mean value from the summary table, along with the confidence interval bounds, represent a typical month’s number of car thefts.

- Propose a headline about the trend in car thefts that is focused on the present and future, but informed by the data you see above. **WRITE ANSWER HERE:** Car Thefts Trending Down in 2025 After High NUmbers in 2023, 2024.
...
Given the above chart, is the difference between the two periods statistically significant? Can we reject the null hypothesis? **WRITE ANSWER HERE:** The p-value is greater than .05, meaning that the drop is more likely due to chance and is not significantly significant.
...
I would tell my editor that although there has been a steep drop, it is not signficantly significant. She may ask for a larger timeframe to find data that makes it look statistically significant.
